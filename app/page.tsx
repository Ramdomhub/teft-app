        ...
        <div className="max-w-[440px] w-full space-y-12">
          ...
          <div className="bg-white rounded-[3rem] overflow-hidden shadow-sm border border-black/[0.02]">
            ...
            <div className="p-10 text-center">
              {/* Hier: Keine Kursivschrift mehr bei TEFT */}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-white/50 p-6 rounded-[2rem] text-center border border-black/[0.03] opacity-50 cursor-not-allowed">
              <span className="text-[10px] font-black uppercase tracking-widest">Staking</span>
            </div>
            
            <div className="bg-zinc-100/50 p-6 rounded-[2rem] text-center border border-dashed border-zinc-300 opacity-80 cursor-default">
